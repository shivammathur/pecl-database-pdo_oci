...
#define REGISTER_PDO_OCI_CLASS_CONST_LONG_DEPRECATED_ALIAS_85(base_name, value) \
		REGISTER_PDO_CLASS_CONST_LONG_DEPRECATED_ALIAS_85(base_name, "OCI_", "Pdo\\Oci::", value)
#endif
...
{
#if PHP_VERSION_ID >= 80500
	REGISTER_PDO_OCI_CLASS_CONST_LONG_DEPRECATED_ALIAS_85("ATTR_ACTION", (zend_long)PDO_OCI_ATTR_ACTION);
	REGISTER_PDO_OCI_CLASS_CONST_LONG_DEPRECATED_ALIAS_85("ATTR_CLIENT_INFO", (zend_long)PDO_OCI_ATTR_CLIENT_INFO);
	REGISTER_PDO_OCI_CLASS_CONST_LONG_DEPRECATED_ALIAS_85("ATTR_CLIENT_IDENTIFIER", (zend_long)PDO_OCI_ATTR_CLIENT_IDENTIFIER);
	REGISTER_PDO_OCI_CLASS_CONST_LONG_DEPRECATED_ALIAS_85("ATTR_MODULE", (zend_long)PDO_OCI_ATTR_MODULE);
	REGISTER_PDO_OCI_CLASS_CONST_LONG_DEPRECATED_ALIAS_85("ATTR_CALL_TIMEOUT", (zend_long)PDO_OCI_ATTR_CALL_TIMEOUT);
#else
